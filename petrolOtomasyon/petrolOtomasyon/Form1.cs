...
namespace petrolOtomasyon
{
    public partial class Form1 : Form
    {
        ...
        private void numericupdown_value()
        {
            ...
            numericUpDown1.Maximum = decimal.Parse(D_benzin97.ToString());
            numericUpDown1.Maximum = decimal.Parse(D_dizel.ToString());
            numericUpDown1.Maximum = decimal.Parse(D_eurodizel.ToString());
            numericUpDown1.Maximum = decimal.Parse(D_lpg.ToString());
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string[] yakýt_türleri = { "Benzin(95)", "Benzin(97)", "Dizel", "Euro Dizel", "Lpg" };
            comboBox1.Items.AddRange(yakýt_türleri);
